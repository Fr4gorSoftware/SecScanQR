...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvInformation = findViewById(R.id.tvTxtqrcode);
        mTvFormat = findViewById(R.id.tvFormat);
        mLabelInformation = findViewById(R.id.labelInformation);
        mLabelFormat = findViewById(R.id.labelFormat);
        mDatabaseHelper = new DatabaseHelper(this);

        BottomNavigationView main_navigation = findViewById(R.id.navigation);
        BottomNavigationViewHelper.disableShiftMode(main_navigation);
        main_navigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        main_navigation.clearFocus();

        action_navigation = findViewById(R.id.main_action_navigation);
    ...
    public void addToDatabase(String newCode, String format) {
        boolean insertData = mDatabaseHelper.addData(newCode);
        if (!insertData) {
