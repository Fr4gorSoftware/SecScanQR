...
public class GeoGeneratorActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    EditText tfLatitude, tfLongitude;
    CheckBox cbLatitude, cbLongitude;
    Boolean north = true, east = true;
    BarcodeFormat format;
    String latitude, longitude, geo;
    MultiFormatWriter multiFormatWriter;
    Bitmap bitmap;
    final AppCompatActivity activity = this;
    private static final String STATE_LATITUDE = MainActivity.class.getName();
    private static final String STATE_LONGITUDE = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tfLatitude = findViewById(R.id.tfLatitude);
        tfLongitude = findViewById(R.id.tfLongitude);
        cbLatitude = findViewById(R.id.cbLatitude);
        cbLongitude = findViewById(R.id.cbLongitude);
        ...
        if (savedInstanceState != null) {
            ...
            longitude = (String) savedInstanceState.get(STATE_LONGITUDE);
        ...
        fab.setOnClickListener(view -> {
            ...
            longitude = tfLongitude.getText().toString().trim();
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putString(STATE_LONGITUDE, longitude);
    ...
    public void onClickCheckboxes(View v) {
        if (cbLatitude.isChecked() && cbLongitude.isChecked()) {
            north = true;
            east = true;
        } else if (!cbLatitude.isChecked() && cbLongitude.isChecked()) {
            north = false;
            east = true;
        } else if (cbLatitude.isChecked() && !cbLongitude.isChecked()) {
            north = true;
