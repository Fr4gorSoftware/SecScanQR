...
public class QrPopup extends Dialog {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        codeImage = findViewById(R.id.image);
    ...
    private void saveQrCode() {
        ...
        File f = new File(Environment.getExternalStorageDirectory().toString()
                + File.separator + "SecScanQR" + File.separator + now + ".jpg");
    ...
    private void createFolder() {
        ...
        if (!storageDir.exists()) {
            if (!storageDir.mkdir()) {
                Toast.makeText(mContext, mContext.getResources().getText(R.string.toast_error), Toast.LENGTH_LONG).show();
            } else {
                saveQrCode();
            }
        } else {
